...
ADDITIONAL_DEFAULT_PRESET_VALUES: dict[str, Any] = {
    ...
    "lora_adam_beta1": 0.9,
    "lora_adam_beta2": 0.999,
    "lora_adam_epsilon": 1e-8,
    "lora_adamw8bit_min_8bit_size": 4096,
    "lora_adamw8bit_percentile_clipping": 100,
    "lora_adamw8bit_block_wise": True,
    "lora_adamw8bit_paged": False,
    "lora_adafactor_epsilon1": 1e-30,
    "lora_adafactor_epsilon2": 1e-3,
    "lora_adafactor_clip_threshold": 1.0,
    "lora_adafactor_decay_rate": -0.8,
    "lora_adafactor_beta1": 0.0,
    "lora_adafactor_scale_parameter": False,
    "lora_adafactor_relative_step": False,
    "lora_adafactor_warmup_init": False,
    ...
    **{f"ap_{key}": DEFAULT_STAGE_VALUES[key] for key in STAGE_KEYS},
    ...
    "sam_batch_overwrite_existing": False,
}
