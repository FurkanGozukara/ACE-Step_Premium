...
def build_lora_training_wrapper(
    ...
    *,
    ...
    def training_wrapper(
        ...
        adam_beta2: Any,
        adam_epsilon: Any,
        adamw8bit_min_8bit_size: Any,
        adamw8bit_percentile_clipping: Any,
        adamw8bit_block_wise: Any,
        adamw8bit_paged: Any,
        adafactor_epsilon1: Any,
        adafactor_epsilon2: Any,
        adafactor_clip_threshold: Any,
        adafactor_decay_rate: Any,
        adafactor_beta1: Any,
        adafactor_scale_parameter: Any,
        adafactor_relative_step: Any,
        adafactor_warmup_init: Any,
        scheduler_type: Any,
        timestep_mode: Any,
        ...
        *sample_setting_values: Any,
        ...
        try:
            ...
            training_args = {
                ...
                "adamw8bit_min_8bit_size": adamw8bit_min_8bit_size,
                "adamw8bit_percentile_clipping": adamw8bit_percentile_clipping,
                "adamw8bit_block_wise": adamw8bit_block_wise,
                "adamw8bit_paged": adamw8bit_paged,
                "adafactor_epsilon1": adafactor_epsilon1,
                "adafactor_epsilon2": adafactor_epsilon2,
                "adafactor_clip_threshold": adafactor_clip_threshold,
                "adafactor_decay_rate": adafactor_decay_rate,
                "adafactor_beta1": adafactor_beta1,
                "adafactor_scale_parameter": adafactor_scale_parameter,
                "adafactor_relative_step": adafactor_relative_step,
                "adafactor_warmup_init": adafactor_warmup_init,
