...
class GenerationParams:
    ...
    Attributes:
        ...
        repaint_dont_switch_with_lyrics: Keep lyric-bearing Repaint requests on
            the repaint path instead of local text-to-music.
...
def generate_music(
    ...
    try:
        ...
        if params.instrumental:
            ...
            params.lyrics = dit_input_lyrics
            params.vocal_language = dit_input_vocal_language
        ...
        dit_generate_kwargs = {
            ...
            "repaint_dont_switch_with_lyrics": params.repaint_dont_switch_with_lyrics,
        ...
        for idx, dit_audio in enumerate(dit_audios):
            ...
            if audio_format == "mp3":
                audio_params["mp3_bitrate"] = getattr(config, "mp3_bitrate", "256k")
            ...
            if audio_tensor is not None and save_dir is not None:
                ...
                try:
                    ...
                    audio_path = audio_saver.save_audio(audio_tensor,
                                                        ...
                                                        format=audio_format,
                                                        channels_first=True,
                                                        mp3_bitrate=getattr(config, "mp3_bitrate", "256k"),
