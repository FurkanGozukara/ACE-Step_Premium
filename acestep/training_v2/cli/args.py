...
def _add_common_training_args(
    ...
    *,
    ...
    g_train.add_argument("--scheduler-type", type=str, default="constant", choices=["cosine", "cosine_restarts", "linear", "constant", "constant_with_warmup"], help="LR scheduler (default: constant)")
